...
*/
  ...
  const links = [
    { link: "/encyclopedia/Fish", title: "encyclopedia/Fish" },
    { link: "/encyclopedia/Fish", title: "encyclopedia/Fish" },
    { link: "/encyclopedia/Fish", title: "encyclopedia/Fish" },
    { link: "/encyclopedia/Fish", title: "encyclopedia/Fish" },
    { link: "/encyclopedia/Fish", title: "encyclopedia/Fish" },
        ...
        style={{
          ...
          >
            ...
            <div className="content-holder">
              ...
              {createAnecdoteVisible && (
                <CreateAnecdote
                  post_id={post.id}
                  user_id={session?.user.id}
                  toggleAnecdoteCreate={toggleAnecdoteCreate}
                  createAnecdoteFunctional={createAnecdoteFunctional}
                  createGuestAnecdoteFunctional={createGuestAnecdoteFunctional}
                />
              )}
              <Anecdotes
                showPopup={showPopup}
                anecdotes={post?.anecdote}
                toggleAnecdoteCreate={toggleAnecdoteCreate}
              />
              <Related links={post?.link} />
              <Contributors contributors={post?.contributor} />
              <CommentSection
                session={session}
                post_id={post?.id}
                comments={comments}
